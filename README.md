...
| [spec-anchored-delivery](https://github.com/rodrigopg/claude-skill-spec-anchored-delivery) | Spec-anchored feature delivery (W1) — Reversa scoping, measured blast radius, parallel agent-team delivery, spec writeback. Requires [Reversa](https://github.com/sandeco/reversa) (`npx reversa install`). |
